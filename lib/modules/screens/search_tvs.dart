...
class SearchTVS extends StatelessWidget {
  SearchTVS({Key? key}) : super(key: key);
                    ...
                    Container(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                            cubit.tvs!.product!.length,
                                (index) =>
                                buildProductItem(cubit.tvs!
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                            cubit.homeTVS!.newProduct!.length,
                                (index) =>
                                buildProductItem(cubit.homeTVS!
